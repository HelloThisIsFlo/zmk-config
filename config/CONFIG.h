...
#define my_tapping_term_main 200 // For the longest time, it was 130. But by separating hrm and thumb, I can afford to have the HRM longer, as I believe it's mostly the Layer that needs to be quick.
#define my_tapping_term_thumb 100 // NOT TUNED YET, maybe same as linger_term would be good (to keep the same intuition)
