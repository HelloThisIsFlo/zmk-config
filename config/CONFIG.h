...
#define my_global_quick_tap_window 100 // TODO: Migrate to 'require-prior-idle-ms' | For now trying the same as linger term. Original: Measured w/ logs, 130ms is a comfortable quick double-tap for me
